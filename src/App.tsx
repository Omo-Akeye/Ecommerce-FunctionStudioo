        ...
        <AnimatePresence>
          {(isActive || isHovered) && (
            <motion.div
              ...
              className={`absolute top-1/2 w-38.75 bg-[#0000008F] backdrop-blur-[7.61px] text-black p-4 rounded-[57px] ${
...
const App = () => {
  ...
  // const [leftOffset, setLeftOffset] = useState(-55);  Horizontal offset in pixels for left image
  // const [rightOffset, setRightOffset] = useState(-115); Horizontal offset in pixels for right image
